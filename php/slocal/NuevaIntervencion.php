...
$InsertarIntervencion = $conexion -> prepare ("INSERT into intervenciones_slocal (persona_ID,fecha,detalle,intervino) VALUES (:persona_ID,:fecha,:detalle,:intervino)");
...
$ObtenerID=$conexion->query("SELECT * from intervenciones_slocal ORDER BY ID DESC LIMIT 1");
